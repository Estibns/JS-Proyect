function compare() {
    ...
    if (scoreOne != scoreTwo) {
        if (scoreOne > scoreTwo)
        { mostrar.textContent = "La opción: " + machineOne + " es mejor. Tiene una memoria RAM de " + optionOne.ram + " GB,un disco duro de " + optionOne.hardDisk + " GB, una pantalla de " + optionOne.screen + "'', una tarjeta de video de " + optionOne.card + "GB y un precio de $" + optionOne.price + ".";}
        else 
        { mostrar.textContent = "La opción: " + machineTwo + " es mejor. Tiene una memoria RAM de " + optionTwo.ram + " GB,un disco duro de " + optionTwo.hardDisk + " GB, una pantalla de " + optionTwo.screen + "'', una tarjeta de video de " + optionTwo.card + "GB y un precio de $" + optionTwo.price + ".";}
    }
    else {
        mostrar.textContent = "Ambas opciones son similares."
    }
}
